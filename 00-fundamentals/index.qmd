...
R will coerce the data types to the most general type. For example, if we mix integers and doubles, R will coerce the integers to doubles. The coercion order is logical < integer < double < character
